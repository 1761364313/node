...
declare const _default: {
    mongodb: {
        count: typeof import("./mongodb/count").default;
        del: typeof import("./mongodb/del").default;
        find: typeof import("./mongodb/find").default;
        get: typeof import("./mongodb/get").default;
        set: typeof import("./mongodb/set").default;
        setmany: typeof import("./mongodb/setmany").default;
        update: typeof import("./mongodb/update").default;
    };
    mysql: {
        count: typeof import("./mysql/count").default;
        del: typeof import("./mysql/del").default;
        find: typeof import("./mysql/find").default;
        get: typeof import("./mysql/get").default;
        set: typeof import("./mysql/set").default;
        setmany: typeof import("./mysql/setmany").default;
        transaction: typeof import("./mysql/transaction").default;
        update: typeof import("./mysql/update").default;
    };
    redis: {
        set: typeof import("./redis/set").default;
        get: typeof import("./redis/get").default;
        update: typeof import("./redis/update").default;
        del: typeof import("./redis/del").default;
    };
    fastdb: {
        set: typeof import("./fastdb/set").default;
        get: typeof import("./fastdb/get").default;
        update: typeof import("./fastdb/update").default;
        del: typeof import("./fastdb/del").default;
        find: typeof import("./fastdb/find").default;
        count: typeof import("./fastdb/count").default;
    };
    promiseLimit: typeof promiseLimit_temp;
};
...
export declare const promiseLimit: typeof promiseLimit_temp;
export declare type TPlatform = 'mongodb' | 'mysql';
export declare type TTable = string;
export declare type TMongodbCheckMethod = '=' | '!=' | '<' | '<=' | '>' | '>=' | 'in' | 'notIn' | 'arrContain' | 'regex' | 'strLength' | 'isExists' | 'geoInclude' | 'geoWithinCircle' | 'geoWithinRegion' | 'geoWithin';
export declare type TMysqlCheckMethod = '=' | '!=' | '<' | '<=' | '>' | '>=' | 'in' | 'notIn' | 'regex' | 'strLength' | 'like' | 'between' | 'notBetween' | 'isNull' | 'isExists';
export declare type TFastdbCheckMethod = '=' | '!=' | '<' | '<=' | '>' | '>=' | 'in' | 'notIn' | 'arrContain' | 'regex' | 'strLength' | 'isExists';
export declare type TMysqlJiaMethod = 'uniqueTable' | 'tableOf' | 'inner' | 'left' | 'right' | 'full' | 'count' | 'sum' | 'max' | 'min' | 'avg' | 'ucase' | 'lcase' | 'mid' | 'len' | 'round' | 'now' | 'format';
export declare type TMysqlJiaParams = 'distinct' | 'all';
export declare type TJ = 'j0' | 'j1' | 'j2' | 'j3' | 'j4' | 'j5' | 'j6' | 'j7' | 'j8' | 'j9';
...
declare type TMongodbUpdateMethod = 'incr' | 'set' | 'unset' | 'geo' | 'append' | 'remove' | 'uAppend';
declare type TMysqlUpdateMethod = 'incr' | 'set' | 'unset';
declare type TFastdbUpdateMethod = 'incr' | 'set' | 'unset' | 'geo' | 'append' | 'remove' | 'uAppend';
declare type TRedisUpdateMethod = 'incr' | 'add' | 'set' | 'range' | 'endSec' | 'endMillisec' | 'endTime' | 'endMilliTime';
...
declare type TMongodbSetMethod = 'geo';
...
export declare type TStructure = 'string' | 'hash' | 'list' | 'set' | 'zset';
